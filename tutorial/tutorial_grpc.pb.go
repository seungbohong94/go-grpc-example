...
func (c *tutorialClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedTutorialServer) SayHello(context.Context, *HelloRequest) (*HelloResponse, error) {
